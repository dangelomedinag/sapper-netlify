<footer class="footer bg-neutral relative pt-1 border-b-2 border-primary-700">
  <div class="container mx-auto px-6">
    <div class="sm:flex sm:mt-8">
      <div
        class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
        <div class="flex flex-col">
          <span class="font-bold text-secondary uppercase mb-2">Redes Sociales</span>
          <span class="my-2"><a
              href="https://www.instagram.com/consweet.cl/"
              class="text-primary-700  text-md hover:text-primary-900">Instagram</a></span>
          <span class="my-2"><a
              href="https://wa.me/56931364370"
              class="text-primary-700  text-md hover:text-primary-900">Whatsapp</a></span>
          <span class="my-2"><a
              href="mailto:consweetdelicias@gmail.com"
              class="text-primary-700  text-md hover:text-primary-900">E-mail</a></span>
        </div>

        <div class="flex flex-col">
          <span
            class="font-bold text-secondary uppercase mt-4 md:mt-0 mb-2">Navegacion</span>
          <span class="my-2"><a
              href="/"
              class="text-primary-700  text-md hover:text-primary-900">Inicio</a></span>
          <span class="my-2"><a
              href="/productos"
              class="text-primary-700  text-md hover:text-primary-900">Productos</a></span>
          <span class="my-2"><a
              href="/contacto"
              class="text-primary-700  text-md hover:text-primary-900">Contacto</a></span>
        </div>
        <div class="flex flex-col justify-center items-center pt-12">
          <svg
            class="w-32 h-auto fill-current text-gray-400 hover:text-primary-700 transition-all duration-300 ease-in-out cursor-pointer"
  ...
  <div class="container mx-auto px-6">
    <div class="mt-16 border-t-2 border-gray-300 flex flex-col items-center">
      <div class="sm:w-2/3 text-center py-6">
        <p class="text-sm text-primary-700 font-bold mb-2">
          © 2020 conSweet - todos los derechos reservados.
        </p>
      </div>
    </div>
  </div>
