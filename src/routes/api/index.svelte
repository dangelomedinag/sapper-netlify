      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="flex items-center ml-3 ">
            <a
              href="#"
              class="px-3 py-1 ml-2 self-center text-sm font-medium text-gray-800 antialiased rounded-md focus:outline-none hover:bg-blue-100 hover:text-blue-500 focus:bg-blue-100">Productos</a>
...
<div class="relative">
  <aside class="h-full bg-neutral w-56 fixed z-0 top-0 left-0 pt-56">
    <div class="w-56 fixed top-0 left-0 pt-16 bg-red-400 h-56">
      <h1>ssdsa</h1>
      <p>dsasdssds</p>
      <code>2154s5da4s54</code>
    </div>
    <hr />
