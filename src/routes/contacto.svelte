...
<div class="lg:container mt-4 px-6 mx-auto">
  <h1 class="text-5xl text-secondary font-light">
  ...
  <div
    class="bg-primary-100 border-t-4 border-primary-700 rounded-b text-teal-900 px-4 py-3 shadow-md"
    role="alert">
    <div class="flex py-3">
      <div class="py-1">
        <svg
